...
export const COLLECTION_DEFAULTS = {
  ...
  'magneetfolie': {
    items: {
      'MAGNEETFOLIE 1M': { price_per_meter: 10.55, calculation_type: 'rol_per_meter' },
      'MAGNEETFOLIE 0,62M': { price_per_meter: 10.55, calculation_type: 'rol_per_meter' },
    }
  },
  'rekkers': {
    items: {
      'REKKERS 25CM': { price_per_piece: 0.82, calculation_type: 'stuk' },
      'REKKERS 20CM': { price_per_piece: 0.82, calculation_type: 'stuk' },
    }
  },
  ...
  'snijfolie': {
    items: {
      ...
      'AVERY 735-01 SILVER METALLIC': { price_per_meter: 6.41, calculation_type: 'rol_per_meter' },
      'AVERY 730 MATT WHITE': { price_per_meter: 5.78, calculation_type: 'rol_per_meter' },
      'AVERY 721 MATT BLACK': { price_per_meter: 5.78, calculation_type: 'rol_per_meter' },
      ...
      'AVERY 703 CHERRY RED': { price_per_meter: 6.41, calculation_type: 'rol_per_meter' },
  ...
  'flex': {
    items: {
      ...
      'FLOCK 200 RED': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 730 COOL GREY': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 780 DARK GREY': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 101 NEON YELLOW': { price_per_meter: 14.28, calculation_type: 'rol_per_meter' },
      'FLOCK 300 ROYAL BLUE': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 001 WHITE': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 180 ORANGE': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 390 AQUA': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'POLY TWILL  GOLD': { price_per_meter: 9.65, calculation_type: 'rol_per_meter' },
      'FLOCK 253 BERRY': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 700 BLACK': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'FLOCK 350 NAVY': { price_per_meter: 12.5, calculation_type: 'rol_per_meter' },
      'SILICONE 200 RED (0,2)': { price_per_meter: 15.89, calculation_type: 'rol_per_meter' },
      'SILICONE 700 BLACK (0,5)': { price_per_meter: 21.47, calculation_type: 'rol_per_meter' },
      'SILICONE 700 BLACK (0,2)': { price_per_meter: 15.89, calculation_type: 'rol_per_meter' },
      'SOFT METALLIC 5200 RED': { price_per_meter: 11.55, calculation_type: 'rol_per_meter' },
      '255 PASTEL PINK': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '200 RED': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '700 BLACK': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '350 NAVY': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '001 WHITE': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '101 NEON YELLOW': { price_per_meter: 7.42, calculation_type: 'rol_per_meter' },
      '115 GOLD': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '422 LIGHT GREEN': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      '401 NEON GREEN': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      'GLITTER 965 RAINBOW PLUM': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'GLITTER 955 HOLO WHITE': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'GLITTER 935 HOLO GOLD': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'GLITTER 928 BLACK': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'GLITTER 921 SILVER': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'GLITTER 943 HOT PINK': { price_per_meter: 10.74, calculation_type: 'rol_per_meter' },
      'DISCO 2003 RED': { price_per_meter: 11.32, calculation_type: 'rol_per_meter' },
      'DISCO 2004 GOLDEN YELLOW': { price_per_meter: 11.32, calculation_type: 'rol_per_meter' },
      'EFFECT 913 CRYSTAL': { price_per_meter: 5.32, calculation_type: 'rol_per_meter' },
      'EFFECT 901 SPECTRUM': { price_per_meter: 5.32, calculation_type: 'rol_per_meter' },
      'EFFECT GLOW IN THE DARK': { price_per_meter: 11.53, calculation_type: 'rol_per_meter' },
      'CAMO': { price_per_meter: 6.33, calculation_type: 'rol_per_meter' },
      'FANCY 200 RED': { price_per_meter: 9.58, calculation_type: 'rol_per_meter' },
      'REST SUBLISTOP': { price_per_meter: 9.52, calculation_type: 'rol_per_meter' },
      '180 ORANGE': { price_per_meter: 6.21, calculation_type: 'rol_per_meter' },
      'SILICONE 200 RED (0,5)': { price_per_meter: 21.47, calculation_type: 'rol_per_meter' },
      'SILICONE WIT 0,2': { price_per_meter: 15.89, calculation_type: 'rol_per_meter' },
    }
  },
  'printfolie': {
    items: {
      'AVERY MPI 2000 1M37': { price_per_meter: 4.58, width_cm: 137, calculation_type: 'rol_per_meter' },
      'AVERY MPI 2000 1M60': { price_per_meter: 5.35, calculation_type: 'rol_per_meter' },
      'AVERY MPI 2004 EA 1M37': { price_per_meter: 6.41, calculation_type: 'rol_per_meter' },
      'AVERY MPI 2006 HI/TA 1M37': { price_per_meter: 6.98, calculation_type: 'rol_per_meter' },
      'AVERY MPI 2040 1M37 TRANS.': { price_per_meter: 6.26, calculation_type: 'rol_per_meter' },
      'AVERY MPI 2040 1M52 TRANS.': { price_per_meter: 6.95, calculation_type: 'rol_per_meter' },
      'AVERY MPI 3000 1M37': { price_per_meter: 2.33, calculation_type: 'rol_per_meter' },
      'AVERY MPI 1105 1M37': { price_per_meter: 12.73, calculation_type: 'rol_per_meter' },
      'AVERY MPI 1105 1M52': { price_per_meter: 15.8, calculation_type: 'rol_per_meter' },
      ...
      'HEXIS VERSTERKTE/GRIJZE LIJMLAAG 1M37 VCSR200WG1': { price_per_meter: 8.26, calculation_type: 'rol_per_meter' },
      'SPANDOEK JET550 1M37': { price_per_meter: 7.13, width_cm: 137, calculation_type: 'rol_per_meter' },
      'SPANDOEK JET550 1M60': { price_per_meter: 8.43, calculation_type: 'rol_per_meter' },
      'SPANDOEK MESH 1M37': { price_per_meter: 7.13, calculation_type: 'rol_per_meter' },
      'SPANDOEK MESH 1M60': { price_per_meter: 8.43, calculation_type: 'rol_per_meter' },
      'NESCHEN MONOMEER 1M37': { price_per_meter: 7.93, calculation_type: 'rol_per_meter' },
      'MICR 02 ONEWAY VISION 1M': { price_per_meter: 14.64, calculation_type: 'rol_per_meter' },
      'MICR 02 ONEWAY VISION 1M37': { price_per_meter: 20.06, calculation_type: 'rol_per_meter' },
      'ONE WAY VISION LAMINAAT 1M37': { price_per_meter: 20.06, width_cm: 137, calculation_type: 'rol_per_meter' },
      '3M CASTING TRANS. IJ180': { price_per_meter: 21.69, calculation_type: 'rol_per_meter' },
      'CANVAS 1M37': { price_per_meter: 14.35, width_cm: 137, calculation_type: 'rol_per_meter' },
      'PAPIER 1M37': { price_per_meter: 5.2, calculation_type: 'rol_per_meter' },
      'ROLL-UP 1M07': { price_per_meter: 2.91, calculation_type: 'rol_per_meter' },
    }
  },
  'swf': {
    items: {
      ...
      'XPEL': { price_per_meter: 111.49, calculation_type: 'rol_per_meter' },
      ...
      '3M 823I VISGRAAD LINKS': { price_per_meter: 41.29, calculation_type: 'rol_per_meter' },
  ...
  'buizen': {
    items: {
      'GRIJS ALVA 42': { price_per_piece: 21.75, calculation_type: 'stuk' },
      ...
      'ZWART ALVA 42': { price_per_meter: 18.09, calculation_type: 'rol_per_meter' },
    }
  },
  'zandstraal': {
    items: {
      ...
      'HEXIS EDGED GLASS 1M': { price_per_meter: 7.96, calculation_type: 'rol_per_meter' },
    }
  },
};
...
// Get all available item names for a collection (for autocomplete)
export function getCollectionItemNames(collectionName) {
  const normalized = collectionName?.toLowerCase().trim();
  const collection = COLLECTION_DEFAULTS[normalized];
  ...
  // If collection has item-based pricing
  if (collection.items) {
    return Object.keys(collection.items);
  }
  ...
  // No items to return for simple collections
  return [];
}
